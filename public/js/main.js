            ...
            <div class="row gx-5">
                <div class="col-auto">
                    <div class="avatar avatar-online">
                        <img class="rounded-circle" src="${chat.participants[0].avatar_url}">
                    </div>
                </div>
                ...
                <div class="col">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="line-clamp me-auto">${chat.last_message.body}</div>
...
$('#chat-list').on('click', '[data-messages]' , function(e){
    ...
    $.get(`/api/conversation/${id}/messages`, function(response){
        ...
        for(i in response.message.data){
            let message = response.message.data[i];
